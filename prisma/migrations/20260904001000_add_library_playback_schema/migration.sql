-- Create the canonical library playback schema after the activity enum values
-- have been committed by 20260904000000_add_library_playback_tracking.
-- Historical library consumption is intentionally not backfilled.
